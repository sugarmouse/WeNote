...
export default function Toolbar({ initialData, preview }: ToolbarProps) {
  ...
  return (
    <div className="pl-[54px] group relative">
      ...
      <div className="opacity-100 group-hover/icon:opacity-100 flex items-center gap-x-1 py-4">
        {!initialData.icon && !preview && (
      ...
      {isEditing && !preview ? (
        ...
        <div
          className="outline-none pb-[11.5px] text-5xl font-bold break-words text-[#3F3F3F] dark:text-[#CFCFCF]"
          onClick={enableInput}
        >
          {initialData.title}
        </div>
